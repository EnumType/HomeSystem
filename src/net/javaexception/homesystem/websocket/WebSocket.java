...
public class WebSocket {
	...
	public static void startWebSocket(int httpPort, int httpsPort, String keystoredir, String keystore, String keystorePassword) {
	...
	public static boolean isWebSocket(InetAddress address) {
		return Handler.sessions.containsKey(address);
	}
